...
def Denoising_read():
    ...
    for path in tqdm(path_list): 
        ...
        for numb in list_number:
            ...
            print(round(max((max(Small_area_max_temp[0::2]) - min(Small_area_max_temp[0::2])),(max(Small_area_max_temp[1::2]) - min(Small_area_max_temp[1::2]))),3))    
            # print(Small_area_max_temp)
            # exit()
            # 异常检测
